    ...
    <header class="main-header">
        <div class="bg-color">
            ...
            <nav class="nav navbar-default">
                <div class="container bor-btm">
                    <div class="col-md-12">
                        <div class="navbar-header">
                        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#mynavbar" aria-expanded="false" aria-controls="navbar">
                            <span class="fa fa-bars"></span>
                        </button>
                            <a href="#" class="navbar-brand">Online Album</a>
                        </div>
            ...
            <div class="container text-center">
                <div class="wrapper">
                    ...
                    <a href="register.php"><button type="submit" class="btn btn-submit" >Register Now</button></a>
                    <!--<h5>Already member?<a href="login.php">Login</a></h5>-->
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="cta-info text-center">
                    <h3><span class="dec-tec">“</span>Smart and Easy Storytelling<span class="dec-tec">”</span></h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <div class="section-title">
                        <h2 class="head-title">Discover amazing stories</h2>
                        <hr class="botm-line">
                        
                        <p class="sec-para">Trending stories from all over the world, submitted by MyAlbum users </p>
                    </div>
                </div>
            ...
            <div class="row white">
                <div class="col-md-8 col-sm-12">
                    <div class="section-title">
                        ...
                        <hr class="botm-line">
                        <p class="sec-para black">tell us...</p>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 col-sm-6" style="padding-left:0px;">
                        ...
                        <div class="contact-info">
                            <form action="">
                                ...
                                <!--    <input name="email" placeholder="Email..." class="contact-email form-control" id="contact-email" type="text">-->
                                <!--</div>-->
                                <div class="form-group">
                                    <input name="email" placeholder="Email..." class="contact-email form-control" id="contact-email" type="text">
                                </div>
                                <div class="form-group">
                                    <textarea name="email" placeholder="Enter Text..." class="form-control" id="" type="text"></textarea>
                                </div>
                                <button type="submit" class="btn btn-send">Send it</button>
                            </form>
                        </div>
                    </div>
    ...
    <footer class="" id="footer">
        <div class="container">
            <div class="row">
                ...
                <!--    © Bethany Bootstrap Template by <a href="http://themeshouter.com/">themeshouter</a>.-->
                <!--</div>-->
